...
export const treatmentCosts = {
  "진찰만 받는 경우": "65세 이상\n1천~2천원대",
  "진찰과 처방전을 받는 경우": "병원비 1천~2천원대부터",
  "진찰, 엑스레이, 처방전을 받는 경우": "65세 이상\n일반 8천~1만원대",
  "진찰, 엑스레이, 물리치료, 처방전을 받는 경우": "65세 이상\n일반 1만~1.5만원대",
  "기타 문의": "상담 필요",
};
...
export const treatmentCostDetails = {
  "진찰만 받는 경우": {
    ...
    note: "통증 첫 방문에서는 엑스레이 검사나 처방전 발급이 함께 진행될 수 있어요.",
    codes: "초진 진찰료 기준",
  },
  "진찰과 처방전을 받는 경우": {
  ...
  "진찰, 엑스레이, 처방전을 받는 경우": {
    ...
    range: "병원 창구 급여 기준: 65세 이상과 일반 대략 8천~1만원대",
    note: "촬영 부위·매수에 따라 달라질 수 있어요.",
    codes: "진찰료 + 기본 엑스레이 촬영 기준",
  },
  "진찰, 엑스레이, 물리치료, 처방전을 받는 경우": {
    subtitle: "검사 후 기본 물리치료와 처방전이 함께 나올 수 있는 경우",
    range: "병원 창구 급여 기준: 65세 이상과 일반 대략 1만~1.5만원대",
    note: "기본 물리치료 조합 기준이라 주사·추가치료는 별도 확인이 필요해요.",
    codes: "진찰료 + 엑스레이 + 기본 물리치료 기준",
  },
  "기타 문의": {
