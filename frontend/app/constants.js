...
export const commonCostQuestions = [
  {
    type: "급여",
    title: "재방문 진찰",
    price: "초진보다 낮게 나오는 경우가 많아요",
    guide: "같은 증상으로 다시 방문하면 초진/재진 구분에 따라 병원 창구 금액이 달라질 수 있어요.",
    question: "오늘은 초진인가요, 재진인가요? 지난번보다 진찰료가 어떻게 달라지나요?",
  },
  {
    type: "급여",
    title: "야간·공휴일 진료",
    price: "가산 때문에 병원비가 올라갈 수 있어요",
    guide: "저녁 시간, 토요일, 공휴일 진료는 급여 항목이어도 시간대 가산이 붙을 수 있어요.",
    question: "지금 시간대에 야간·공휴일 가산이 붙나요? 붙으면 병원비가 얼마나 달라지나요?",
  },
  {
    type: "급여",
    title: "65세 이상 본인부담",
    price: "나이에 따라 창구 부담이 달라질 수 있어요",
    guide: "의원급 외래는 나이와 총 진료비 구간에 따라 본인부담이 달라질 수 있어요.",
    question: "65세 이상 본인부담 기준이 적용되나요? 검사까지 포함하면 부담금이 어떻게 바뀌나요?",
  },
];
