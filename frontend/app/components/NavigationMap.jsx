    ...
    <div className={wrapperClass}>
      ...
      <div className="flex items-center gap-4 bg-[#004D40] px-6 py-5 text-white lg:px-4 lg:py-3">
        ...
        <div className="min-w-0">
          <p className="truncate text-2xl font-black lg:text-lg">
            {isLocating ? "위치 확인 중..." : instruction}
          </p>
          {routeInfo && (
            <p className="mt-1 text-base font-bold text-[#80CBC4] lg:text-sm">
      ...
      {/* 출발지 선택 바 */}
      <div className="border-b border-[#E0E0E0] bg-[#F8F9FA] px-6 py-3 lg:px-4 lg:py-2">
        <div className="flex items-center justify-between gap-2">
          <div className="min-w-0">
            <p className="text-sm font-bold text-boyak-muted lg:text-xs">출발지</p>
            <p className="truncate text-base font-black text-boyak-ink lg:text-sm">{locLabel}</p>
          </div>
          <div className="flex shrink-0 gap-2">
            <button
              className="rounded-lg border border-[#30343B] bg-white px-3 py-2 text-sm font-black text-boyak-ink lg:px-2 lg:py-1 lg:text-xs"
              type="button"
              onClick={resetToGps}
            >
              현재 위치
            ...
            <button
              className="rounded-lg bg-boyak-green px-3 py-2 text-sm font-black text-white lg:px-2 lg:py-1 lg:text-xs"
              type="button"
        ...
        {showAddressInput && (
          <div className="mt-3 flex gap-2">
            <input
              className="flex-1 rounded-lg border border-[#30343B] px-4 py-3 text-lg font-bold outline-none focus:border-boyak-green lg:py-2 lg:text-base"
              type="text"
            ...
            />
            <button
              className="rounded-lg bg-boyak-green px-4 py-3 text-lg font-black text-white disabled:opacity-50 lg:px-3 lg:py-2 lg:text-base"
              type="button"
      ...
      {/* 지도 */}
      {routeError ? (
        <div className="flex h-[320px] w-full items-center justify-center bg-[#EFF1F4] p-8 text-center lg:h-[180px]">
      ...
      <div className="p-6 lg:p-4">
        ...
        {routeInfo && (
          <div className="mb-4 flex flex-wrap gap-3 rounded-xl bg-[#f8f9fa] px-4 py-3 text-lg font-bold lg:mb-3 lg:text-base">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            className="min-h-[80px] rounded-2xl border-2 border-[#30343B] bg-white px-4 text-xl font-black lg:min-h-14 lg:text-base"
            type="button"
            onClick={onArrive}
          >
            🔄 안내 종료
          ...
          <button
            className={`min-h-[80px] rounded-2xl px-4 text-2xl font-black text-white transition lg:min-h-14 lg:text-lg ${
